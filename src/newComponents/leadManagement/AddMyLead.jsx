...
//         <InputField name="noOfDays" type="number" value={formData.noOfDays} onChange={handleChange} />
...
//         <InputField name="value" type="number" value={formData.value} onChange={handleChange} />
//       </div>
...
//             <div className="space-y-3">
//               <div><strong className="block text-gray-700">Name:</strong> <span>{viewLead.name || "-"}</span></div>
//               <div><strong className="block text-gray-700">Email:</strong> <span>{viewLead.email || "-"}</span></div>
//               <div><strong className="block text-gray-700">Phone:</strong> <span>{viewLead.phone || "-"}</span></div>
//               <div><strong className="block text-gray-700">Departure City:</strong> <span>{viewLead.departureCity || "-"}</span></div>
//               <div><strong className="block text-gray-700">Destination:</strong> <span>{viewLead.destination || "-"}</span></div>
//               <div><strong className="block text-gray-700">Travel Date:</strong> <span>{formatDate(viewLead.expectedTravelDate)}</span></div>
//               <div><strong className="block text-gray-700">Lead Source:</strong> <span>{viewLead.leadSource || "-"}</span></div>
//               <div><strong className="block text-gray-700">Lead Status:</strong> <span>{viewLead.leadStatus || "-"}</span></div>
//               <div><strong className="block text-gray-700">Notes:</strong> <span>{viewLead.notes || "-"}</span></div>
//             </div>
//           </div>
//         </div>
//       )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50" onClick={closeModal}>
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div><strong className="block text-gray-700">Lead Source:</strong> <span>{viewLead.leadSource || "-"}</span></div>
              <div><strong className="block text-gray-700">Lead Status:</strong> <span>{viewLead.leadStatus || "-"}</span></div>
              <div><strong className="block text-gray-700">Child Ages:</strong> <span>{(viewLead.childAges || []).join(", ") || "-"}</span></div>
              <div><strong className="block text-gray-700">Notes:</strong> <span>{viewLead.notes || "-"}</span></div>
            </div>
          </div>
        </div>
